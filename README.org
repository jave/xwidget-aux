...
*** TODO 6) Did you test what happens with xwidgets when the lines are
...
*** TODO 8) Do we really need to expose xwgir-require-namespace?  Can't
...
>
*** TODO 11) The doc strings of functions exposed to Lisp that are defined on
>     xwidget.c are not yet finished.

Yes.

*** TODO 12) A question about configuration: are xwidgets only supported in a
